...
impl App for GeneratorAppState {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.hyperlink_to("View Setup & Usage Instructions Online", "https://github.com/RIZAmohammadkhan/GuiKeyStandalone/blob/main/activity_generator_gui/GENERATOR_GUIDE.md");
            ui.add_space(10.0);
